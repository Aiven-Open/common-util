 ...
 * 
 * @see <a href=
 *      "https://raw.githubusercontent.com/apache/httpcomponents-core/refs/heads/master/httpcore5/src/main/java/org/apache/hc/core5/http/HttpStatus.java">HttpStatus</a>
 */
public final class HttpStatus {
	...
	/**
	 * {@code 226 IM Used} (Delta encoding in HTTP - RFC 3229, p. 30, section
	 * 10.4.1)
	 */
	...
	/**
	 * {@code 431 Request Header Fields Too Large} (Additional HTTP Status Codes -
	 * RFC 6585)
	 */
	...
	/**
	 * {@code 506 Variant Also Negotiates} ( Transparent Content Negotiation - RFC
	 * 2295)
	 */
	...
	/**
	 * {@code 510 Not Extended} (An HTTP Extension Framework - RFC 2774, p. 10,
	 * section 7)
	 */
	public static final int SC_NOT_EXTENDED = 510;

	/**
	 * {@code  511 Network Authentication Required} (Additional HTTP Status Codes -
	 * RFC 6585)
	 */
