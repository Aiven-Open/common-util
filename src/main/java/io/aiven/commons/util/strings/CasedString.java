...
public class CasedString {
  ...
  private static final Function<String[], String> PASCAL_JOINER =
      strings -> {
  ...
  public static class StringCase {
    /**
     * Camel case tags strings like 'CamelCase' or 'camelCase'. This conversion forces the first
     * character to lower case. If the first character is desired to be upper case use PASCAL case
     * instead.
     */
    public static final StringCase CAMEL =
        new StringCase(
            ...
            true,
            PASCAL_JOINER.andThen(WordUtils::uncapitalize),
            x -> StringUtils.defaultIfEmpty(x, null));

    /**
     * Camel case tags strings like 'PascalCase' or 'pascalCase'. This conversion forces the first
     * character to upper case. If the first character is desired to be lower case use CAMEL case
     * instead.
     */
    ...
    /**
     * Snake case tags strings like 'Snake_Case'. This conversion does not change the capitalization
     * of any characters in the string. If specific capitalization is required use {@link
     * String#toUpperCase()}, {@link String#toLowerCase()}, or the commons-text methods {@link
     * WordUtils#capitalize(String)}, or {@link WordUtils#uncapitalize(String)} as required.
     */
    public static final StringCase SNAKE = new StringCase("SNAKE", '_');

    /**
     * Kebab case tags strings like 'kebab-case'. This conversion does not change the capitalization
     * of any characters in the string. If specific capitalization is required use {@link
     * String#toUpperCase()}, {@link String#toLowerCase()}, * or the commons-text methods {@link
     * WordUtils#capitalize(String)}, or {@link WordUtils#uncapitalize(String)} as required.
     */
    ...
    /**
     * Phrase case tags phrases of words like 'phrase case'. This conversion does not change the
     * capitalization of any characters in the string. If specific capitalization is required use
     * {@link String#toUpperCase()}, {@link String#toLowerCase()}, * or the commons-text methods
     * {@link WordUtils#capitalize(String)}, or {@link WordUtils#uncapitalize(String)} as required.
     */
    public static final StringCase PHRASE =
        new StringCase("PHRASE", Character::isWhitespace, false, simpleJoiner(' '));

    /**
     * Dot case tags phrases of words like 'phrase.case'. This conversion does not change the
     * capitalization of any characters in the string. If specific capitalization is required use
     * {@link String#toUpperCase()}, {@link String#toLowerCase()}, * or the commons-text methods
     * {@link WordUtils#capitalize(String)}, or {@link WordUtils#uncapitalize(String)} as required.
     */
    ...
    /**
     * Slash case tags phrases of words like 'phrase.case'. This conversion does not change the
     * capitalization of any characters in the string. If specific capitalization is required use
     * {@link String#toUpperCase()}, {@link String#toLowerCase()}, * or the commons-text methods
     * {@link WordUtils#capitalize(String)}, or {@link WordUtils#uncapitalize(String)} as required.
     */
     ...
     * @param preserveSplit if {@code true} the character that the splitter detected is preserved as
     *     the first character of the new word.
     * @param joiner The function to merge a list of strings into the cased String.
     */
    public StringCase(
        final String name,
        final Predicate<Character> splitter,
        final boolean preserveSplit,
        final Function<String[], String> joiner) {
      this(name, splitter, preserveSplit, joiner, Function.identity());
    }

    /**
     * Create a simple string case for the delimiter. Items will be split on the delimiter. Arrays
     * of strings will be joined by the delimiter, null strings will be discarded.
     *
    ...
    /**
     * Creates a function to join a String array with a character delimiter. Null strings are
     * discarded. Empty strings will be processed and result in leading or trailing delimiters (if
     * at the start or end of the array) or extra delimiters in other positions.
     *
     * @param delimiter the character to join the string array with.
     ...
     *     the first character of the new word.
     * @param joiner The function to merge a list of strings into the cased String.
     * @param postProcess A function to perform post split processing on the generated String array.
     */
    public StringCase(
        final String name,
        final Predicate<Character> splitter,
    ...
    /**
     * Returns an array of each of the segments in this CasedString. Segments are defined as the
     * strings between the separators in the CasedString. For the CAMEL case the segments are
  ...
  /**
   * Creates a new cased string from this one but with the new case. If the {@code stringCase} is
   * the same as the current case this object returned.
   *
   * @param stringCase the case to convert this CasedString to.
  ...
  /**
   * Converts this cased string into a {@code String} of another format. The upper/lower case of the
   * characters within the string are not modified.
   *
