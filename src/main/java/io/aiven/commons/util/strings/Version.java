...
/**
 * Reads a list of versions from a configuration file. Versions may be retrieved by calling {@link
 ...
 * }</pre>
 *
 * If additional values from the properties are desired then creating an instance of {@code Version}
 * and calling {@link #of(String)} for the desired properties will work.
 */
public final class Version {
   ...
   * @return the property stirng, "unknown" if not set, or an error message if the file was not
   *     read.
   */
