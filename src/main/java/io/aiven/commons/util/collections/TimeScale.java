...
/**
 * Scales milliseconds into standard human time units and standard human time units into
 * milliseconds. Also provides formatting for the same.
 */
...
public enum TimeScale {
   ...
   *
   * @param milliseconds the number of milliseconds in the time unit.
   */
  ...
  /**
   * Format the number of milliseconds in this TimeScale along with the number of Milliseconds. For
   * example "3.5 minutes (210000 milliseconds)". If the Timescale is MILLISECONDS then the
   * parenthetical portion is not displayed.
   *
   * @param milliseconds the number of milliseconds to format.
   * @return the String representation of the number and TimeUnit as well as the number of
   *     milliseconds.
   */
  public String displayValue(final long milliseconds) {
    return format(milliseconds)
        + (this == MILLISECONDS ? "" : " (" + MILLISECONDS.format(milliseconds) + ")");
  }
   ...
   *
   * @param unitCount the number of TimeScale units.
   ...
   *
   * @param unitCount the number of TimeUnits
  ...
  public static TimeScale scaleOf(final long milliseconds) {
    final List<TimeScale> ordered = new ArrayList<>(Arrays.asList(values()));
