...
public enum TimeScale {
	...
	/**
	 * Format the number of milliseconds in this TimeScale along with the number of
	 * Milliseconds. For example "3.5 minutes (210000 milliseconds)". If the
	 * Timescale is MILLISECONDS then the parenthetical portion is not displayed.
	 *
	 * @param milliseconds
	 *            the number of milliseconds to format.
	 * @return the String representation of the number and TimeUnit as well as the
	...
	/**
	 * Returns the largest TimeScale that will represent {@code milliseconds} with
	 * at least 1 unit.
	 *
	 * @param milliseconds
	 *            the number of milliseconds
	...
	/**
	 * Formats the milliseconds into a TimeScale that best fits the number of
	 * milliseconds.
	 *
	 * @param milliseconds
	 *            the number of milliseconds.
