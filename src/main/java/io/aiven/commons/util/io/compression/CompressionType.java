...
/**
 * Enumeration of standard compression types along with methods to compress and decompress standard
 * file extensions for the type.
 */
public enum CompressionType {
  ...
  /**
   * A function that will return an input stream that decompresses the data in a provided input
   * stream.
   */
  private final IOFunction<InputStream, InputStream> decompressor;

  /**
   * A function that will return an output stream that compresses the data in a provided output
   * stream.
   */
   ...
   * Constructor
   *
   * @param extensionStr The file extension associated with the compression.
   * @param decompressor A function that will return an input stream that decompresses the data in a
   *     provided input stream.
   * @param compressor A function that will return an output stream that compresses the data in a
  ...
  /**
   * Decompresses an input stream. To function correctly the resulting input stream must be used in
   * a try/catch block. Failure to do so will result in compression errors. Example:
   *
   * <pre>{@code
   ...
   *
   * @param source the compressed byte array.
  ...
  /**
   * Compresses an output stream. To function correctly the resulting output stream * must be used
   * in a try/catch block. Failure to do so will result in compression errors. * Example: *
   *
   * <pre>{@code
