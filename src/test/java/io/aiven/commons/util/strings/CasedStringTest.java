...
public class CasedStringTest {
  ...
  static Stream<Arguments> testSegmentationData() {
    ...
    lst.add(
        Arguments.of("CamelCase", CasedString.StringCase.CAMEL, new String[] {"Camel", "Case"}));
    lst.add(
        Arguments.of(
            "CamelPMDCase",
            CasedString.StringCase.CAMEL,
    ...
    lst.add(
        Arguments.of(
            ...
            new String[] {"camel", "P", "M", "D", "Case"}));
    lst.add(
        Arguments.of("PascalCase", CasedString.StringCase.PASCAL, new String[] {"Pascal", "Case"}));
    lst.add(
        Arguments.of(
            "PascalPMDCase",
            CasedString.StringCase.PASCAL,
    ...
    lst.add(
        Arguments.of(
            ...
            new String[] {"pascal", "P", "M", "D", "Case"}));
    lst.add(
        Arguments.of("snake_case", CasedString.StringCase.SNAKE, new String[] {"snake", "case"}));
    lst.add(
        Arguments.of("snake_Case", CasedString.StringCase.SNAKE, new String[] {"snake", "Case"}));
    lst.add(
        Arguments.of(
            "snake__Case", CasedString.StringCase.SNAKE, new String[] {"snake", "", "Case"}));
    lst.add(
        Arguments.of("kebab-case", CasedString.StringCase.KEBAB, new String[] {"kebab", "case"}));
    lst.add(
        Arguments.of("kebab-Case", CasedString.StringCase.KEBAB, new String[] {"kebab", "Case"}));
    lst.add(
        Arguments.of(
            "kebab--case", CasedString.StringCase.KEBAB, new String[] {"kebab", "", "case"}));
    lst.add(
        Arguments.of(
            "phrase case", CasedString.StringCase.PHRASE, new String[] {"phrase", "case"}));
    lst.add(
        Arguments.of(
            "phrase Case", CasedString.StringCase.PHRASE, new String[] {"phrase", "Case"}));
    lst.add(
    ...
    lst.add(
        Arguments.of("dot..case", CasedString.StringCase.DOT, new String[] {"dot", "", "case"}));
    lst.add(Arguments.of("dot.Case", CasedString.StringCase.DOT, new String[] {"dot", "Case"}));
    return lst.stream();
  }
