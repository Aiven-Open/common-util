...
public class EnvCheckTest {
  ...
  void testCredentialSourceUrl() throws IOException, NoSuchFieldException, IllegalAccessException {
    ...
    try {
      ...
      assertThat(EnvCheck.allowed(EnvCheck.Type.URI, testURL))
  ...
  void testCredentialSourceFile() throws IOException, NoSuchFieldException, IllegalAccessException {
    ...
    try {
      ...
      assertThat(EnvCheck.allowed(EnvCheck.Type.FILE, testFile))
          .as("test against null env value")
          .isFalse();
  ...
  void testCredentialSourceCommand()
    ...
    try {
      ...
      assertThat(EnvCheck.allowed(EnvCheck.Type.CMD, testCmd))
          .as("test against null env value")
          .isFalse();
