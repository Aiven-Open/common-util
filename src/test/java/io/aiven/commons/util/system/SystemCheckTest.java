...
public class SystemCheckTest {
  ...
  void testCredentialSourceFile() throws IOException, NoSuchFieldException, IllegalAccessException {
    ...
    try {
      ...
      assertThat(SystemCheck.allowed(SystemCheck.Type.FILE, testFile))
          .as("test against null env value")
          .isFalse();
  ...
  @Test
  void testCredentialSourceCommand()
    ...
    try {
      ...
      assertThat(SystemCheck.allowed(SystemCheck.Type.CMD, testCmd))
          .as("test against null env value")
          .isFalse();
